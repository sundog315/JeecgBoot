...
export const formSchema: FormSchema[] = [
  {
    ...
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入生效标志!' }];
    },
  },
  {
    label: '设备型号',
    ...
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入设备型号!' }];
    },
  },
  {
    label: '脚本名称',
    ...
    component: 'Input',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入脚本名称!' }];
    },
  },
  {
    label: '脚本存放路径',
    ...
    component: 'Input',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入脚本存放路径!' }];
    },
  },
  {
    label: '当前版本',
    ...
    component: 'Input',
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入当前版本!' }];
    },
  },
  {
    label: '脚本内容',
    ...
    dynamicRules: ({ model, schema }) => {
      return [{ required: true, message: '请输入脚本内容!' }];
    },
  },
  // TODO 主键隐藏字段，目前写死为ID
  {
