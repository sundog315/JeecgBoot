...
<script lang="ts" setup>
  ...
  const validatorRules = {
    ...
    dhcpEnd: [
      { required: true, message: '请输入DHCP截至地址!' },
      { pattern: /^-?\d+\.?\d*$/, message: '请输入数字!' },
    ],
