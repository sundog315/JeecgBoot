...
<script lang="ts" setup>
  ...
  const validatorRules = {
    ipaddr: [{ required: true, message: '请输入内网地址!'}, { pattern: '^(?:(?:1[0-9][0-9]\.)|(?:2[0-4][0-9]\.)|(?:25[0-5]\.)|(?:[1-9][0-9]\.)|(?:[0-9]\.)){3}(?:(?:1[0-9][0-9])|(?:2[0-4][0-9])|(?:25[0-5])|(?:[1-9][0-9])|(?:[0-9]))$', message: '不符合校验规则!'},],
    netmask: [{ required: true, message: '请输入子网掩码!'}, { pattern: '^(?:(?:1[0-9][0-9]\.)|(?:2[0-4][0-9]\.)|(?:25[0-5]\.)|(?:[1-9][0-9]\.)|(?:[0-9]\.)){3}(?:(?:1[0-9][0-9])|(?:2[0-4][0-9])|(?:25[0-5])|(?:[1-9][0-9])|(?:[0-9]))$', message: '不符合校验规则!'},],
