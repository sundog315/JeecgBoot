          ...
          <a-row>
            <a-col :span="24">
              <a-form-item label="设备标识" v-bind="validateInfos.deviceSn" id="CpeDeviceInfoForm-deviceSn" name="deviceSn">
                <a-input v-model:value="formData.deviceSn" placeholder="请输入设备标识" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="24">
            ...
            <a-col :span="24">
              <a-form-item label="在线频段" v-bind="validateInfos.onlineBand" id="CpeDeviceInfoForm-onlineBand" name="onlineBand">
                <a-input v-model:value="formData.onlineBand" placeholder="请输入在线频段" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="24">
