          ...
          <a-row>
						<a-col :span="24">
							<a-form-item label="客户端IP" v-bind="validateInfos.clientIp" id="CpeDeviceClient-clientIp" name="clientIp">
								<a-input v-model:value="formData.clientIp" placeholder="请输入客户端IP"  allow-clear ></a-input>
							</a-form-item>
						</a-col>
						<a-col :span="24">
							<a-form-item label="客户端MAC" v-bind="validateInfos.clientMac" id="CpeDeviceClient-clientMac" name="clientMac">
								<a-input v-model:value="formData.clientMac" placeholder="请输入客户端MAC"  allow-clear ></a-input>
							</a-form-item>
						</a-col>
						<a-col :span="24">
							<a-form-item label="上线时间" v-bind="validateInfos.attachTs" id="CpeDeviceClient-attachTs" name="attachTs">
								<a-input v-model:value="formData.attachTs" placeholder="请输入上线时间"  allow-clear ></a-input>
							</a-form-item>
						</a-col>
						<a-col :span="24">
							<a-form-item label="刷新时间" v-bind="validateInfos.refreshTs" id="CpeDeviceClient-refreshTs" name="refreshTs">
								<a-input v-model:value="formData.refreshTs" placeholder="请输入刷新时间"  allow-clear ></a-input>
							</a-form-item>
						</a-col>
						<a-col :span="24">
