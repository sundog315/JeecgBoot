          ...
          <a-row>
            <a-col :span="24">
              <a-form-item label="服务器地址" v-bind="validateInfos.serverAddr" id="CpeDeviceFrp-serverAddr" name="serverAddr">
                <a-input v-model:value="formData.serverAddr" placeholder="请输入服务器地址" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="24">
            ...
            <a-col :span="24">
              <a-form-item label="令牌" v-bind="validateInfos.token" id="CpeDeviceFrp-token" name="token">
                <a-input v-model:value="formData.token" placeholder="请输入令牌" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="24">
              <a-form-item
                label="SSH映射端口"
                v-bind="validateInfos.proxySshRemotePort"
                id="CpeDeviceFrp-proxySshRemotePort"
                name="proxySshRemotePort"
              >
            ...
            <a-col :span="24">
              <a-form-item
                label="HTTP映射端口"
                v-bind="validateInfos.proxyHttpRemotePort"
                id="CpeDeviceFrp-proxyHttpRemotePort"
                name="proxyHttpRemotePort"
              >
