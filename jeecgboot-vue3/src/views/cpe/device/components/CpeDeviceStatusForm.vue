          ...
          <a-row>
            ...
            <a-col :span="24">
              <a-form-item label="RAT" v-bind="validateInfos.rat" id="CpeDeviceStatus-rat" name="rat">
                <a-input v-model:value="formData.rat" placeholder="请输入RAT" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="24">
              <a-form-item label="频段" v-bind="validateInfos.onlineBand" id="CpeDeviceStatus-onlineBand" name="onlineBand">
                <a-input v-model:value="formData.onlineBand" placeholder="请输入频段" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="24">
              <a-form-item label="运营商名称" v-bind="validateInfos.cops" id="CpeDeviceStatus-cops" name="cops">
                <a-input v-model:value="formData.cops" placeholder="请输入运营商名称" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="24">
              <a-form-item label="SINR" v-bind="validateInfos.sinr" id="CpeDeviceStatus-sinr" name="sinr">
                <a-input v-model:value="formData.sinr" placeholder="请输入SINR" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="24">
            ...
            <a-col :span="24">
              <a-form-item label="CELLID" v-bind="validateInfos.cellId" id="CpeDeviceStatus-cellId" name="cellId">
                <a-input v-model:value="formData.cellId" placeholder="请输入CELLID" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="24">
              <a-form-item label="PCID" v-bind="validateInfos.pcid" id="CpeDeviceStatus-pcid" name="pcid">
                <a-input v-model:value="formData.pcid" placeholder="请输入PCID" allow-clear />
              </a-form-item>
            </a-col>
            <a-col :span="24">
