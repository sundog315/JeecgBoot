  ...
  <div class="p-2">
    ...
    <BasicTable @register="registerTable" :rowSelection="rowSelection">
      ...
      <template #tableTitle>
        ...
        <j-upload-button type="primary" v-auth="'cpe.device:cpe_device:importExcel'" preIcon="ant-design:import-outlined" @click="onImportXls"
          >导入</j-upload-button
        >
        <a-dropdown v-if="selectedRowKeys.length > 0">
          ...
          <a-button v-auth="'cpe.device:cpe_device:deleteBatch'"
            >批量操作
    ...
    <!-- 表单区域 -->
    <CpeDeviceModal ref="registerModal" @success="handleSuccess" />
  </div>
</template>
