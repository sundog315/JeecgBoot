...
<script lang="ts" setup>
  ...
  const validatorRules = reactive({
    deviceSn: [{ required: true, message: '请输入设备标识!'}, { validator: deviceSnDuplicatevalidate }],
  ...
  async function deviceSnDuplicatevalidate(_r, value) {
    return duplicateValidate('cpe_device_info', 'device_sn', value, formData.id || '')
  }
  defineExpose({
    add,
    edit,
