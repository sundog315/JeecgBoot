package org.jeecg.modules.cpe.device.vo;
 ...
 */
@Data
@ApiModel(value="cpe_device_infoPage对象", description="设备信息表")
public class CpeDeviceInfoPage {
    ...
    private java.lang.String upBytes;
	/**下行流量*/
	@Excel(name = "下行流量", width = 15)
	@ApiModelProperty(value = "下行流量")
    private java.lang.String downBytes;
	/**时间戳*/
	@Excel(name = "时间戳", width = 15)
	@ApiModelProperty(value = "时间戳")
    private java.lang.String ts;

	@ExcelCollection(name="CPE设备状态表")
	@ApiModelProperty(value = "CPE设备状态表")
	private List<CpeDeviceStatus> cpeDeviceStatusList;
	@ExcelCollection(name="CPE设备邻区信息")
	@ApiModelProperty(value = "CPE设备邻区信息")
	private List<CpeDeviceNeighbor> cpeDeviceNeighborList;
