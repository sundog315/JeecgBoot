 ...
 */
@Data
@TableName("cpe_speed_limit")
@ApiModel(value="cpe_speed_limit对象", description="设备速率")
public class CpeSpeedLimit implements Serializable {
